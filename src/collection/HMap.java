...
public class HMap {
	...
	public static void main(String[] args) {
		...
		*/
		// HashMap should also be capital letter
		/* after Map press ctrl+space then add from java.util, there should be key & value, so put your desirable 
		 data type in key and value i.e String and Integer after Hash press ctrl+space then java.util*/
		//sometimes we have to import from Set and HashMap if it dont come automatic
		...
		// Entry should import from Java.Util
